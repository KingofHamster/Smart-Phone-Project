...
import com.tencent.qcloud.tim.uikit.component.picture.imageEngine.GlideCircleTransform;
...
public class GlideEngine implements ImageEngine {
    ...
    public static void loadImage(ImageView imageView, Object uri) {
        ...
        Glide.with(TUIKit.getAppContext())
                .load(uri)
                .apply(new RequestOptions().error(R.drawable.ic_avatar_female))
                .into(imageView);
    }
    public static void loadCircleImage(ImageView imageView, Object uri) {
        if (uri == null) {
            return;
        }
        GlideCircleTransform transform = new GlideCircleTransform();
        RequestOptions options = new RequestOptions()
                .centerCrop()
