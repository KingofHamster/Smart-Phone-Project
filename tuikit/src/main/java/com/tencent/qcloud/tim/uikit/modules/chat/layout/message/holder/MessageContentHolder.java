...
public abstract class MessageContentHolder extends MessageEmptyHolder {
    ...
    public void layoutViews(final MessageInfo msg, final int position) {
        ...
        if (properties.getAvatar() != 0) {
            ...
            leftUserIcon.setDefaultImageResId(R.drawable.ic_avatar_female);
            rightUserIcon.setDefaultImageResId(R.drawable.ic_avatar_female);
        }
        ...
        //// 聊天气泡设置
        if (msg.isSelf()) {
            if (msg.getExtra().equals("[红包]")) {
                msgContentFrame.setBackgroundResource(R.drawable.im_red_package_right);
            } else if (properties.getRightBubble() != null && properties.getRightBubble().getConstantState() != null) {
            ...
            if (msg.getExtra().equals("[红包]")) {
                msgContentFrame.setBackgroundResource(R.drawable.im_red_package_left);
            } else if (properties.getLeftBubble() != null && properties.getLeftBubble().getConstantState() != null) {
